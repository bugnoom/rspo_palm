...
export default class FormInput5 extends Component {
  ...
  constructor(props){
    ...
    this.state = {
      ...
      tableHead: ['#','วันที่', 'ค่าปุ๋ย', 'ค่าจ้างใส่ปุ๋ย'],
  ...
  openform = () => {
    this.props.navigation.navigate('FormInput5_AddEdit')
  }
  ...
  render() {
    ...
    const tableData = [];
    const colData = [
                      [this.element(0),'24/04/2562','500','10000'],
                      [this.element(1),'25/04/2562','500','10000'],
                      [this.element(2),'26/04/2562','500','2000'],
                      [this.element(3),'27/04/2562','500','2000'],
                    ];
