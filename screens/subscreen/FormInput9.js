...
export default class FormInput9 extends Component {
  ...
  constructor(props){
    ...
    this.state = {
      ...
      tableHead: ['#','วันที่','ชนิดศัตรูพืช', 'ชื่อสารเคมี','อัตราที่ใช้'],
      widthArr: [40, 100, 100, 150, 150]
    }
  }
  ...
  openform = () => {
    this.props.navigation.navigate('FormInput9_AddEdit')
  }
  ...
  render() {
    ...
    const tableData = [];
    const colData = [
                      [this.element(0),'24/04/2562','TestData A','Data A','1:60'],
                      [this.element(1),'25/04/2562','TestData B','Data B','2:30'],
                      [this.element(2),'26/04/2562','TestData C','Data C','3:40'],
                      [this.element(3),'27/04/2562','TestData D','Data D','5:40'],
                    ];
