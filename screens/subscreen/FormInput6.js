...
export default class FormInput6 extends Component {
  ...
  openform = () => {
    this.props.navigation.navigate('FormInput6_AddEdit')
  }
  ...
  render() {
    ...
    const tableData = [];
    const colData = [
                      [this.element(0),'24/04/2562','R&D Devision'],
                      [this.element(1),'25/04/2562','R&D Devision'],
                      [this.element(2),'26/04/2562','R&D Devision'],
                      [this.element(3),'27/04/2562','R&D Devision'],
                    ];
