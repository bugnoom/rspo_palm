...
export default class FormInput14 extends Component {
  ...
  constructor(props){
    ...
    this.state = {
      ...
      tableHead: ['#','วันที่', 'ผู้ประเมิน','ผลการประเมินโดยรวม'],
      widthArr: [40, 100, 180,120 ]
    }
  }
  ...
  openform = () => {
    this.props.navigation.navigate('FormInput14_AddEdit')
  }
  ...
  render() {
    ...
    const tableData = [];
    const colData = [
                      [this.element(0),'24/04/2562','TestData A','Data A'],
                      [this.element(1),'25/04/2562','TestData B','Data B'],
                      [this.element(2),'26/04/2562','TestData C','Data C'],
                      [this.element(3),'27/04/2562','TestData D','Data D'],
                    ];
