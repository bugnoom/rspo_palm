...
export default class FormInput10 extends Component {
  ...
  constructor(props){
    ...
    this.state = {
      ...
      tableHead: ['#','วันที่','ปริมาณน้ำฝน', 'ความชื้นสัมพัทธ์'],
      widthArr: [40, 100, 180,180 ]
    }
  }
  ...
  openform = () => {
    this.props.navigation.navigate('FormInput10_AddEdit')
  }
