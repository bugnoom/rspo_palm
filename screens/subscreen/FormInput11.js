...
export default class FormInput11 extends Component {
  ...
  constructor(props){
    ...
    this.state = {
      ...
      tableHead: ['#','วันที่', 'เรื่อง','สถานที่'],
      widthArr: [40, 100, 180,160 ]
    }
  }
  ...
  openform = () => {
    this.props.navigation.navigate('FormInput11_AddEdit')
  }
