...
export default class FormInput8 extends Component {
  ...
  constructor(props){
    ...
    this.state = {
      ...
      tableHead: ['#','วันที่','อาการขาดธาตุอาหาร', 'ความรุนแรง'],
      widthArr: [40, 100, 180,100]
    }
  }
  ...
  openform = () => {
    this.props.navigation.navigate('FormInput8_AddEdit')
  }
  ...
  render() {
    ...
    const tableData = [];
    const colData = [
                      [this.element(0),'24/04/2562','ขาดธาตุบำรุงใบ','รุนแรง'],
                      [this.element(1),'25/04/2562','ขาดธาตุบำรุงใบ','ปานกลาง'],
                      [this.element(2),'26/04/2562','ขาดธาตุบำรุงใบ','เล็กน้อย'],
                      [this.element(3),'27/04/2562','ขาดธาตุบำรุงใบ','เล็กน้อย'],
                    ];
